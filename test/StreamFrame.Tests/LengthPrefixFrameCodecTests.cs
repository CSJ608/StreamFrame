...
public class LengthPrefixFrameCodecTests
{
    private static (byte[] frame, ReadOnlySequence<byte> buffer) EncodeSingle(IFrameCodec codec, byte[] payload)
    {
    ...
    {
        var codec = new LengthPrefixFrameCodec();
